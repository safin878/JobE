...
// const section1 = () => {
//   return (
//     <div className="flex flex-col md:flex-row bg-blue-500 clip-right-angle   overflow-hidden h-screen  ">
//       {/* Left Side (Blue Background) */}
//       <div className="relative w-full md:w-1/2 ">
//         <div className="p-8 md:p-12 lg:p-16 text-white">
//           <p className="text-lg md:text-xl lg:text-2xl font-semibold mb-4">
//             This is the first paragraph on the left side. It can describe your
//             product or service.
//           </p>
//           <p className="text-base md:text-lg lg:text-xl mb-6">
//             This is the second paragraph. Add more details or a call-to-action
//             here.
//           </p>
...
//       {/* Right Side (Image) */}
//       <div className="relative w-full md:w-1/2 clip-left-angle">
//         <img
